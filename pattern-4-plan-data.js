window.PATTERN_4_PLAN_MODEL = {
  ...
  nextSteps: [
    ...
    "DONE locally — Genie Workspace chart rendering: `askGenie` source returns columns+rows and the app renders Domo-side KPI/line/bar/scatter/table visuals. Await explicit user approval before creating/releasing the live `pattern4ce` version.",
    "Sprint 8 (approved Lakebase reuse): create Lakebase tables in `cobra-v1`, add Lakebase functions to `pattern4ce`, build the Lakebase Ops page.",
