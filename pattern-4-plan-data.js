window.PATTERN_4_PLAN_MODEL = {
  ...
  nextSteps: [
    ...
    "Sprint 7 next step: Model Serving endpoint `pattern4-renewal-risk` is READY on `pattern4_renewal_risk_v5` and `pattern4ce.runModelInference` is released in v1.0.12 — only the in-Domo click-test remains.",
