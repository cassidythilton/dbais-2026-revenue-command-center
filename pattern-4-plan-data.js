window.PATTERN_4_PLAN_MODEL = {
  ...
  nextSteps: [
    ...
    "Ask a Databricks metastore admin to grant `CREATE EXTERNAL METADATA` on metastore `metastore_aws_us_east_1` to the current Pattern 4 principal, then rerun external lineage creation for all six `gold_*` tables.",
