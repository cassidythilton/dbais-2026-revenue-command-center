#!/usr/bin/env python3
"""Create + release pattern4ce v1.0.18.
...
VERSION = "1.0.18"
DESCRIPTION = (
    "Consolidated Pattern 4 CE package. v1.0.18: startRetentionWorkflow resolves the latest "
    "ACTIVE workflow version dynamically (no hardcoded version) + writeback INSERT...SELECT fix. "
    "Stops the CE/workflow version-pin cascade."
)
