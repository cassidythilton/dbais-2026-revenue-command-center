#!/usr/bin/env python3
"""Create + release pattern4ce v1.0.15.
...
VERSION = "1.0.15"
DESCRIPTION = (
    "Consolidated Pattern 4 CE package. v1.0.15: adds askRetentionAgent "
    "(Domo AI agent tile -> Databricks Agent Bricks Supervisor Agent / MAS "
    "mas-77bd204b-endpoint, Genie-backed). All prior functions unchanged."
)
