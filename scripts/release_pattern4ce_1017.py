#!/usr/bin/env python3
"""Create + release pattern4ce v1.0.17.
...
VERSION = "1.0.17"
DESCRIPTION = (
    "Consolidated Pattern 4 CE package. v1.0.17: FIX writeActionStatus + trace-row insert "
    "to use INSERT ... SELECT (Databricks rejects uuid()/current_timestamp() in VALUES "
    "inline tables) so the agent_action_writeback actually lands. All else unchanged."
)
