...
- `pattern4ce` v1.0.6 (Genie wait-for-completed + fallback answer fix) is created but **not released**. Release requires explicit user approval; until then, the published app still uses the v1.0.5 Genie behavior.
