...
- 2026-06-10 GATE: after this round the user must (1) Deploy workflow **v1.0.2** (1.0.0 is locked/superseded), (2) `domo publish` latest `dist`, (3) re-instantiate the App Studio card (20 aliases) — then the agent tile won't hang and the in-app Approvals tab is live.
